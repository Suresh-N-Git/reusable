...
class ReusableTableComponent {
    ...
    getExportData() {
        const columns = this.displayedColumnsExtended.filter(column => this.displayedColumnIds.includes(column.id) && column.id !== 'actions');
